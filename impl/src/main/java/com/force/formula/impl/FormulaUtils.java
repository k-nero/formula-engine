...
import com.force.formula.parser.gen4.ANTLR4ErrorStrategy;
import com.force.formula.parser.gen4.ANTLR4GrammarVisitor;
import com.force.formula.parser.gen4.ANTLR4Utils;
...
public class FormulaUtils
{
    ...
    public static List<String> getNameAndDomainFromFieldName(String fieldName)
    {
        ...
        assert nameAndDomain == null || nameAndDomain.size() <= 2;
    ...
    public static Set<String> getFieldReferences(Formula form, FormulaContext context)
    {
        ...
        if (form instanceof InvalidFormula)
        {
