...
public class FormulaFieldReferenceInfoImpl implements FormulaFieldReferenceInfo
{
    ...
    private final FormulaSchema.FieldOrColumn fieldOrColumnId;
    ...
    public boolean equals(Object obj)
    {
        ...
        {
            if (other.fieldOrColumnId != null)
            {
                return false;
            }
        }
        else if (!this.fieldOrColumnId.equals(other.fieldOrColumnId))
        {
            return false;
        }
        if (this.foreignKeyDomain == null)
        {
            return other.foreignKeyDomain == null;
        }
        else return this.foreignKeyDomain.equals(other.foreignKeyDomain);
    }
}
