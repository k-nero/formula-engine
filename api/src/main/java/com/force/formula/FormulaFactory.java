...
public interface FormulaFactory
{
     ...
     *
     * @param type            the type of formula being constructed
     * @param context         field definition that the formula is bound to
     * @param source          formula specification in textual format
     * @param existingFormula whether an existing formula is being loaded
     * @param forceDisabled   whether to create the formula as a disabled formula, even if the encoded text doesn't say it's disabled
     * @return Formula object
     * @throws FormulaException if an exception occurs when creating the formula
     */
     ...
     * @param existingFormula whether an existing formula is being loaded
     * @param forceDisabled   whether to create the formula as a disabled formula, even if the encoded text doesn't say it's disabled
     * @param isCreateOrEdit  whether this action is design time (edit/create) or runtime
     * @return Formula object
     * @throws FormulaException if an exception occurs when creating the formula
     */
    RuntimeFormulaInfo create(FormulaTypeSpec type, FormulaContext context, String source, boolean existingFormula,
     ...
     * @param context    field definition that the formula is bound to
     * @param source     formula specification in textual format
     * @param properties the formula properties that specify the formula creation parameters
     * @return Formula object
     * @throws FormulaException if an exception occurs when creating the formula
     */
