...
import com.force.formula.util.FormulaTextUtil.TrieMatch;
...
public class TrieMatcherTest extends TestCase
{
    ...
    private static final List<String> cacheablePaths = Lists.newArrayList(
            "/dwnld",
            "/css/",
            "/img",
            "/EXT"
    ...
    public void testConstructor() throws Exception
    {
        try
        {
            TrieMatcher.compile(null, new String[0]);
            fail();
        }
        ...
        try
        {
            TrieMatcher.compile(new String[0], null);
            fail();
        }
        catch (NullPointerException expected)
        {
